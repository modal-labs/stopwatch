...
async def run_benchmark_suite(
    ...
    *,
    ...
    logging.info("step 0/4: validating benchmarks...")
    ...
    logging.info("step 1/4: run synchronous and throughput benchmarks...")
    ...
    logging.info("step 2/4: run benchmark at constant rates...")
    benchmarks_to_run = []
    ...
    # STEP 2.5: (Re) create benchmark suite tables
    logging.info("step 2.5/4: (re)creating benchmark suite tables...")
    for suite_class in [SuiteBenchmark, SuiteAveragedBenchmark]:
        suite_class.__table__.drop(engine, checkfirst=True)
        suite_class.__table__.create(engine)
    ...
    # benchmark.
    logging.info("step 3/4: averaging benchmark results...")
    parameters = {}
    ...
    logging.info("step 4/4: export results to frontend format...")
